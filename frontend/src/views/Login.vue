    ...
    <div class="bg-grey-lighter flex flex-col">
      <div class="container w-full md:w-2/3 lg:w-1/2 max-w-2xl mx-auto flex-1 flex flex-col items-center px-2">
        <div class="bg-white px-6 py-8 rounded text-black w-full mt-10">
          ...
          <InputBox title="Password" type="password" name="password" id="password" :visible=visible url="/find/password" @sendVal="updatePassword" @submit="callLogin"/>
        ...
        <div class="text-base">
          ...
          <a class="no-underline border-b border-blue font-bold text-blue-700" @click="goJoinPage" style="cursor: pointer">
            Join
          </a>
        </div>
      </div>
