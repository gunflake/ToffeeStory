  ...
  <nav class="bg-white flex p-2 items-center" role="navigation">
    ...
    <div class="hidden md:flex flex-grow">
      ...
      <div class="hidden lg:block ml-6">
        <div class="font-sans pt-1" style="font-family: 'Roboto Slab', serif;font-size: large; color:#1f845b;">TOFFEE STORY</div>
        <div class="text-sm font-sans" style="white-space: nowrap;font-family: 'Indie Flower', cursive;">Toppings for everyone</div>
      </div>
      <!-- Search -->
